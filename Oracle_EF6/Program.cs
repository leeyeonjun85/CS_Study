...
namespace OracleEFCore6
{
    class Program
    {
        ...
        public class BloggingContext : DbContext
        {
            ...
            {
                optionsBuilder.UseOracle(@"User Id=testuser1;Password=0330;Data Source=XEPDB1");
                //DATA SOURCE = localhost:1521 / XEPDB1; TNS_ADMIN = C:\Users\leeyeonjun\Oracle\network\admin; PERSIST SECURITY INFO = True; USER ID = TESTUSER1
            }
        }
